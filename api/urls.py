...
router.register(r'claim', views_1_2.ClaimViewSet, base_name='claims2')
router.register(r'organization', views_1_2.OrganizationViewSet, base_name='organizations2')
router.register(r'polygon', views_1_2.PolygonViewSet, base_name='polygon2')
router.register(r'polygon/get_nearest', views_1_2.GetNearestPolygons, base_name='get_nearest_polygons2')
router.register(r'polygon/check_in', views_1_2.CheckInPolygon, base_name='check_in_polygon2')
router.register(r'polygon/get_tree', views_1_2.GetPolygonsTree, base_name='get_polygons_tree2')
router.register(r'update', views_1_2.GetUpdatedViewSet, base_name='updated2')
